...
(function() {
  var Benchmark, Chrome, async, extractTimestampData, findDebuggerEventInTree, findInTreeByType, maxConnectionTries, runTest, startTest, _;
  ...
  runTest = function(url, port, doneFun) {
    ...
    tryConnect = function(connectCallback) {
      ...
      return chromeConnection.on('connect', function(chrome) {
        return connectCallback(null, chrome);
      });
    };
  ...
  Benchmark = (function() {
    ...
    Benchmark.prototype.processMemoryEvents = function(counters, gc) {
      ...
      groupedGcEvents = _.groupBy(gcEventsToProcess, function(evt) {
        return evt.endTime < this.lastCountersEventTime;
      });
