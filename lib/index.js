...
(function() {
  var benchmarkHtml, benchmarkJs, benchmarkJsSrc, benchmarkJsStream, benchmarkUrl, benchmarkWithServer, concatStream, finalhandler, fs, http, jsTestTemplate, launchChrome, launcher, path, runTest, serveStatic, _;
  ...
  benchmarkJs = function(jsPath, opts, done) {
    ...
    try {
      return benchmarkJsStream(fs.createReadStream(jsPath), opts, done);
    } catch (_error) {
      e = _error;
      return done(e);
    }
  ...
  benchmarkJsStream = function(stream, opts, done) {
    var write;
    if (_.isFunction(opts) && (done == null)) {
      done = opts;
      opts = {};
    }
    write = concatStream(function(data) {
      return benchmarkJsSrc(data, opts, done);
    });
  ...
  benchmarkJsSrc = function(src, opts, done) {
    var server;
    if (_.isFunction(opts) && (done == null)) {
      done = opts;
      opts = {};
  ...
  module.exports = {
    ...
    html: benchmarkHtml,
    js: benchmarkJs,
    jsSrc: benchmarkJsSrc,
    jsStream: benchmarkJsStream
  };
